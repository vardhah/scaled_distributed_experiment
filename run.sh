...
cd $root_directory/src/House/HouseFederate-java-federates/HouseFederate-impl-java/House/target/
xterm -fg cyan -bg black -l -lf $logs_directory/house4-${timestamp}.log -T "House 4" -geometry 140x40+700+350 -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar House-0.1.0-SNAPSHOT.jar -configFile=conf/HouseConfig.json" &
