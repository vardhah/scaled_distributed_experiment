...
public class HouseConfig2 extends FederateConfig {
	@FederateParameter
	...
	@FederateParameter
	public double tsp = 24.0; // temperature setpoint 'C
	
	@FederateParameter
	public double del=0.5;	// thermostat hysteresis
	
	@FederateParameter
	public double plugload=1750;	// plugload
	
	@FederateParameter
	public double solarpaneleffectivearea=36;
}
